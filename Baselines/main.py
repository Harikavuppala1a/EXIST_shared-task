                                            ...
                                            for att_dim in conf_dict["att_dims"]:
                                                for stack_rnn_flag in conf_dict["stack_rnn_flags"]:
                                                    ...
                                                    for thresh in conf_dict["threshes"]:
                                                        ...
                                                        write_results(conf_dict_com['language'], word_feat_str,sent_enc_feat_str, class_imb_flag,conf_dict_com['use_emotions'],conf_dict_com['use_hashtags'],conf_dict_com['use_empathfeats'], conf_dict_com['use_perspectivefeats'], conf_dict_com['use_hurtlexfeats'], metr_dict,f_tsv, conf_dict_com['prob_type'],conf_dict_com,rnn_dim,att_dim)
                                                        if conf_dict_com['gen_insights']:                                                  
                                                            ...
                                                            testdata_analysis(pred_vals_across_runs[0], true_vals)
